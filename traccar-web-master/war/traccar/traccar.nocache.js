...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "traccar" because\n';
  ...
  $wnd.__gwt_activeModules['traccar'] = {
    'moduleName' : 'traccar',
    'bindings' : function() {
      return {};
    }
 ...
 * "/traccar.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['traccar'].superdevmode = true;

  var expectedSuffix = '/traccar.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + traccar + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:traccar';
  var devModeSessionKey = '__gwtDevModeSession:traccar';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':14613';
  var nocacheUrl = serverUrl + '/traccar/traccar.nocache.js';
  ...
  $wnd.__gwt_activeModules['traccar'].canRedirect = true;
  $wnd.__gwt_activeModules['traccar'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/traccar?user.agent=' + ua + '&_callback=' + callback;
